...
const NewCategory = () => {
    ...
    useEffect(() => {
        axios('/admin/get_all_communities_categories')
            .then(categoryData => {
    ...
    const EditCategory = e => {
        ...
        let url = e.action ? '/admin/hideCommunityCategories' : '/admin/showCommunityCategories';
        axios.post(url, {
            communityCategoryId: e.categoryId
        })
            .then(categoryData => {
                if (categoryData.data.summary === "success") {
                    setCategoryData(categoryData.data.message);
                                                        ...
                                                        {categoryData.map((category, index) => {
                                                            return (
                                                                <div key={index}>
                                                                    ...
                                                                    <p>{category.CommunityRecords.length} communities present</p>
                                                                    <button
